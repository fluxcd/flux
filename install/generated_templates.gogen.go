...
var templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 7, 26, 8, 52, 31, 538418553, time.UTC),
		},
		"/flux-account.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "flux-account.yaml.tmpl",
			modTime:          time.Date(2019, 7, 26, 8, 52, 31, 536639495, time.UTC),
		...
		"/flux-deployment.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 7, 26, 8, 52, 31, 537189261, time.UTC),
		...
		"/flux-secret.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 7, 26, 8, 52, 31, 537769968, time.UTC),
		...
		"/memcache-dep.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 7, 26, 8, 52, 31, 538291388, time.UTC),
		...
		"/memcache-svc.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 7, 26, 8, 52, 31, 538759867, time.UTC),
