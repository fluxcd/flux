...
fluxctl install --git-url 'git@github.com:<your username>/flux-get-started' | kubectl -f -`,
	...
	cmd.Flags().BoolVar(&opts.NoSecurityContext, "no-security-context", false, "Ensure that no security context information is added to the pod specs. Defaults to 'false'")
