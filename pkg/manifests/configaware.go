		...
		for id, generated := range resources {
			if duplicate, ok := resourcesByID[id]; ok {
				...
				case duplicate.configFile == cf:
					// the duplicate is _also_ generated by this config file
					duplicateErr = fmt.Errorf("duplicate definitions of resource %s generated by %s",
						id, cf.ConfigVsOriginalPath())
