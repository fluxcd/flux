...
type Mock struct {
	...
	SyncFunc           func(SyncDef, map[string]policy.Update, map[string]policy.Update) error
...
func (m *Mock) Sync(c SyncDef, l map[string]policy.Update, p map[string]policy.Update) error {
	return m.SyncFunc(c, l, p)
}
