...
https://github.com/kubernetes/client-go/blob/4b43750b963d2b6e0f7527fe558e71c47bfc5045/dynamic/fake/simple.go
and modified in the following way(s):

 - the package was changed to `kubernetes`

This file is here because it has a fix for
https://github.com/kubernetes/client-go/issues/465, which is included
in client-go v9, which we're not able to vendor at this time.

It can be removed, and the fake clientset from the original package
used, when we are ready to vendor client-go v9 and kubernetes-1.12.
*/
...
func TestFakeClientConstruction(t *gotesting.T) {
}
