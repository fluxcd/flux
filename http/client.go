...
func (c *client) SetConfig(_ flux.InstanceID, config flux.InstanceConfig, clear bool) error {
	return invokeSetConfig(c.client, c.token, c.router, c.endpoint, config, clear)
}
